export default {
  monitor: {
    ...
    degradation: {
      ...
      description:
        'Probes each target on a schedule to see which model the upstream actually returns, and flags it here when attribution falls short. Group-level credential marks are never touched.',
      configure: 'Check settings',
      add: 'Add monitors',
      refresh: 'Refresh',
      loading: 'Loading degradation monitors…',
      stale: 'Showing the last successful result because the latest refresh failed.',
      loadFailed: 'Unable to load degradation monitors.',
      globallyDisabled:
        'Degradation checks are switched off globally, so nothing runs on a schedule. Manual runs still work.',
      activeRuns: '{count} checks are queued or running; results refresh automatically.',
      tableLabel: 'Degradation monitors',
      runFailed: 'Unable to check “{target}”.',
      ...
      empty: {
        title: 'No degradation monitors yet',
        description:
          'Add monitors by group or by credential, and they will run on the schedule you set.',
      },
      meta: {
        on: 'Enabled',
        off: 'Disabled',
      ...
      filters: {
        ...
        searchPlaceholder: 'Group, credential, or model',
        ...
        onlyPaused: 'Paused only',
      },
      toast: {
        runFinished: 'Checked “{target}”: {state}.',
        deleted: 'Degradation monitor removed.',
        runAlreadyQueued: 'The selected monitors are already in the check queue.',
        batch: {
          enable: 'Enabled {count} monitors.',
          disable: 'Paused {count} monitors.',
          delete: 'Removed {count} monitors.',
          clear: 'Cleared the degradation mark on {count} monitors.',
          run: 'Queued an immediate check for {count} monitors; results refresh automatically.',
        },
      },
      batch: {
        ...
        clear: 'Clear mark',
        delete: 'Remove',
        deleteTitle: 'Remove degradation monitors',
        deleteDescription: 'This removes the {count} selected monitors and their run history.',
      },
      state: {
        unknown: 'Not checked',
        healthy: 'Healthy',
      ...
      reason: {
        low_probability: 'Attribution below threshold',
        model_mismatch: 'Attributed to a different model',
        expected_not_enrolled: 'Expected model is not in the fingerprint set',
        group_disabled: 'Group is disabled',
        credential_disabled: 'Credential is disabled',
        quota_exhausted: 'Quota exhausted',
        empty_response: 'Upstream returned an empty response',
        internal_error: 'Internal error',
        invalid_credential: 'Credential is invalid',
        invalid_request: 'Upstream rejected the request',
        model_unavailable: 'Upstream does not serve this model',
        rate_limited: 'Rate limited',
        route_unsupported: 'This channel does not support the check',
        target_unavailable: 'Target is currently unavailable',
        upstream_error: 'Upstream error',
        upstream_overloaded: 'Upstream overloaded',
        upstream_timeout: 'Upstream timed out',
        credential_not_found: 'Credential not found',
        group_has_no_credential: 'Group has no credential',
        target_is_empty: 'Target is empty',
      },
      trigger: {
        schedule: 'Scheduled',
        manual: 'Manual',
        overload: 'Overload trigger',
      },
      effort: {
      ...
      form: {
        presets: 'Common intervals',
        range: 'Range {min} – {max}',
        inherit: 'Inherit',
        inheritHint: 'Leave empty to inherit: {value}',
        inheritOption: 'Inherit ({value})',
        ...
        upstreamModelHint: 'The model ID actually sent upstream, e.g. gpt-6-astra.',
        upstreamModelPlaceholder: 'gpt-6-astra',
        upstreamModelRequired: 'Enter a request model.',
        expectedModel: 'Expected model',
        expectedModelHint:
          'The model attribution should land on. Landing on another model counts as degraded.',
        expectedModelPlaceholder: 'Pick the expected model',
        expectedModelRequired: 'Pick an expected model.',
        reasoningEffort: 'Reasoning effort',
        reasoningEffortHint:
          'Sent with each probe request. Pick “Upstream default” to omit the parameter.',
        runWhenDisabled: 'Check while the group is disabled',
        runWhenDisabledHint:
          'Lets you spot a disabled group that is no longer degraded, so you can re-enable it.',
        sampleCount: 'Samples',
        minProbability: 'Attribution threshold',
        interval: 'Check interval',
        cooldownInterval: 'Cooldown interval',
        note: 'Note',
        noteHint: 'Shown on this page only. It never writes to the group credential mark.',
        noteTooLong: 'Keep the note under {max} characters.',
      },
      settings: {
        title: 'Degradation check settings',
        description: 'Global defaults. Every monitor can override them individually.',
        save: 'Save settings',
        invalid: 'Some fields are invalid. Fix them and try again.',
        saveFailed: 'Unable to save settings.',
        methodHint:
          'Attribution method: {method}. {recommended} samples recommended; fingerprints calibrated on {calibrated} samples.',
        sections: {
          schedule: 'Schedule',
          verdict: 'Verdict',
          execution: 'Execution',
          overload: 'Overload trigger',
          notifications: 'Notifications (reserved)',
        },
        enabled: 'Enable degradation checks',
        enabledHint: 'When off nothing runs on a schedule. Manual runs still work.',
        interval: 'Healthy check interval',
        intervalHint: 'How often monitors in the healthy state are re-checked.',
        cooldown: 'Cooldown check interval',
        cooldownHint:
          'How often degraded, failing, or paused monitors are re-checked, so you can catch a recovery.',
        runWhenDisabled: 'Check while the group is disabled',
        runWhenDisabledHint:
          'Lets you spot a disabled group that is no longer degraded, so you can re-enable it.',
        ...
        concurrencyHint: 'How many checks may run at the same time.',
        timeout: 'Request timeout',
        timeoutHint: 'Timeout for a single probe request.',
        retryLimit: 'Retries',
        retryLimitHint: 'Retries after a failed sample.',
        quarantine: 'Consecutive-error quarantine',
        quarantineHint:
          'Pause a monitor after this many consecutive failures. 0 disables quarantine.',
        retention: 'History retention',
        retentionHint: 'Runs older than this are pruned.',
        overloadTrigger: 'Check immediately on overload',
        overloadTriggerHint:
          'When a credential request matches an overload keyword, check that target right away.',
        overloadKeywords: 'Overload keywords',
        overloadKeywordsHint: 'Comma separated, up to {max}, case insensitive.',
        overloadKeywordsInvalid: 'Invalid keyword list. Separate entries with commas.',
        overloadRetry: 'Overload check retries',
        overloadRetryHint: 'Retries after an overload-triggered check fails.',
        overloadScan: 'Error scan interval',
        overloadScanHint: 'How often request errors are scanned for overload keywords.',
        overloadDebounce: 'Per-target debounce',
        ...
        notifyOnRecovered: 'Notify when back to healthy',
        notifyOnError: 'Notify when a check fails',
      },
      enroll: {
        title: 'Add degradation monitors',
        description:
          'Add whole groups, or pick individual credentials. Probe fields left empty inherit the global settings.',
        submit: 'Add',
        failed: 'Unable to add monitors.',
        invalid: 'Some fields are invalid. Fix them and try again.',
        noTargets: 'Pick at least one target first.',
        tooManyTargets: 'Add at most {max} targets at a time.',
        result: '{created} created, {updated} updated, {skipped} skipped, {rejected} rejected.',
        modeLabel: 'Add by',
        byGroup: 'Group',
        ...
        sections: {
          targets: 'Targets',
          probe: 'Probe',
          rejected: 'Rejected targets',
        },
        groups: 'Groups',
        groupSearch: 'Search groups',
        groupSearchPlaceholder: 'Group name or channel',
        clearSearch: 'Clear search',
        ...
        group: 'Group',
        groupHint: 'Pick a group first, then choose credentials below.',
        groupPlaceholder: 'Pick a group',
        groupSummary: '{count} groups selected.',
        credentialSummary: '{count} credentials selected.',
        credentialSearch: 'Search credentials',
        credentialSearchPlaceholder: 'Credential mask',
        selectAllCredentials: 'Select page',
        clearCredentials: 'Clear selection',
        loadingCredentials: 'Loading credentials…',
        noCredentials: 'No matching credentials in this group.',
        credentialTruncated: 'Showing the first {shown} of {total}. Narrow it down with search.',
        credentialStatus: {
          available: 'Available',
          cooldown: 'Cooling down',
          blacklisted: 'Blacklisted',
        ...
        skipExisting: 'Skip existing monitors',
        skipExistingHint: 'When off, existing monitors are overwritten with these probe fields.',
        rejectedCredential: 'Group #{group} · credential #{credential}',
        rejectedGroup: 'Group #{group}',
      },
      monitorForm: {
        title: 'Edit degradation monitor',
        description: 'Adjust this monitor. Fields left empty inherit the global settings.',
        enabled: 'Enable this monitor',
        enabledHint: 'When paused it stops running on a schedule. Manual runs still work.',
        save: 'Save',
        invalid: 'Some fields are invalid. Fix them and try again.',
        saveFailed: 'Unable to save the monitor.',
      },
      runs: {
        title: 'Run history',
        description: 'Recent checks for this monitor.',
        loading: 'Loading run history…',
        loadFailed: 'Unable to load run history.',
        emptyTitle: 'No runs yet',
        emptyDescription: 'Once this monitor has run a check, the result appears here.',
        listLabel: 'Runs',
        detailTitle: 'This run',
        expected: 'Expected model',
        detected: 'Attributed model',
        noDetection: 'No model attributed',
        expectedProbability: 'Expected model probability',
        threshold: 'Threshold',
        leadingProbability: 'Leading probability',
        samples: 'Samples',
        samplesValue: '{used} of {total} used, {attempts} requests',
        startedAt: 'Started',
        duration: 'Duration',
        durationMs: '{value} ms',
        ...
        sampleNumbers: '{parsed} numbers parsed (minimum {minimum})',
        stats: 'History totals',
        statsTotal: '{count} checks',
        statsHealthy: 'Healthy',
        statsDegraded: 'Degraded',
        statsInconclusive: 'Inconclusive',
        statsError: 'Error',
        statsQuota: 'Quota exhausted',
        statsUnknown: 'Unknown',
        statsSchedule: 'Scheduled',
        statsManual: 'Manual',
        statsOverload: 'Overload',
        statsHint:
          'Totals cover every check still kept for this monitor, not just the ones listed below.',
        output: 'Model output',
        outputHint: 'The raw upstream answers from this check. Copy one to read it in full.',
        outputEmpty: 'This check did not keep any model output.',
        outputChars: '{value} chars',
        outputTruncated: 'Truncated',
        copySample: 'Copy sample {index}',
        copyAll: 'Copy every sample',
        copySuccess: 'Copied',
      ...
      record: {
        ...
        paused: 'Paused',
        detected: 'Attributed to {model}',
        threshold: 'Threshold {value}',
        everyInterval: 'Every {value}',
        everyCooldown: 'Cooling down, every {value}',
        selectMonitor: 'Select {target}',
        runNow: 'Check {target} now',
        editMonitor: 'Edit the monitor for {target}',
        viewRuns: 'View run history for {target}',
        removeMonitor: 'Remove the monitor for {target}',
      },
    },
    logs: {
