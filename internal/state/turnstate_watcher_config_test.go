...
func TestParseTurnStateWatcherConfigRejectsInvalidValues(t *testing.T) {
	...
	cases := []struct {
		...
		{"overflow poll interval", map[string]any{"poll_interval_seconds": int64(9_223_372_037)}},
		{"overflow verify interval", map[string]any{"verify_interval_seconds": int64(9_223_372_037)}},
		{"overflow verify timeout", map[string]any{"verify_timeout_seconds": int64(9_223_372_037)}},
